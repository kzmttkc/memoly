...
- [ ] Owner: Stripe 台帳 Price アーカイブ・商品名「就業規則AI …」
...
- [ ] Owner: Supabase に `supabase/pack_invites.sql` を適用
- [x] banto webhook が pack checkout を招待処理（Word配信は触らない）
- [ ] Owner: Resend（DIGEST_FROM_EMAIL）確認後、購入翌日に同じメールで /zure または signup が届く
