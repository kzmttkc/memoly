...
// ============================================================================
// MemoryBalanceMeter — 「就業規則AIが自社について覚えていること：N件」を常時表示する。
// ----------------------------------------------------------------------------
//   LTV施策(解約防止の主装置)。就業規則AIの価値は「使うほど自社を覚える＝乗り換えると
      ...
      <Card interactive className="bg-brand-50/40">
        <div className="flex items-center gap-4">
          ...
          <div className="min-w-0 flex-1">
            <p className="text-xs text-neutral-500">就業規則AIが自社について覚えていること</p>
            {loading ? (
        ...
        {!loading && total > 0 && (
          <p className="mt-3 text-xs leading-relaxed text-neutral-500">
            相談・判断・規程を重ねるほど積み上がります。増えるほど、就業規則AIは御社専用に鋭くなります。
          </p>
        )}
      </Card>
    </Link>
