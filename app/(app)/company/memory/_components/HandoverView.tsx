...
// 引き継ぎサマリーをプレーンテキスト化（コピー用）。就業規則AIの継続記憶を1通の引き継ぎ書に。
function buildHandoverText(d: HandoverData): string {
  ...
  lines.push('')
  lines.push('※ 本サマリーは就業規則AIが会社の記憶として残してきた内容の要約です。最終的な判断・手続きは一次情報と専門家でご確認ください。')
  ...
  return (
    <div>
      ...
      <p className="mb-6 rounded-xl border border-brand-100 bg-brand-50/40 px-4 py-3 text-sm leading-relaxed text-neutral-700">
        人は代わっても、就業規則AIは覚えています。この1画面で、{d.companyName}の労務ルール・過去の判断・関係者ごとの状況・現行リスクを引き継げます。
      </p>
      ...
      <section className="mb-7">
        ...
        {d.decisions.length ? (
          ...
          <Card className="text-sm text-neutral-500">
            ...
            で方針が決まると、就業規則AIが「会社の記憶に残しますか」と確認し、ここに積み重なります。
          </Card>
        )}
      </section>
      ...
      <p className="mt-6 border-t border-neutral-200 pt-4 text-xs leading-relaxed text-neutral-500">
        本サマリーは就業規則AIが会社の記憶として残してきた内容の要約です。最終的な判断・手続きは一次情報と専門家でご確認ください。
      </p>
