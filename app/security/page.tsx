...
export const metadata: Metadata = {
  title: 'セキュリティとデータ保護 | 就業規則AI',
  description:
    '就業規則AIのセキュリティ対策の説明。会社ごとのデータ分離(RLS)、暗号化、AI学習への不使用、データの保持期間・エクスポート・削除、委託先の一覧。',
      ...
      <div className="mx-auto max-w-2xl px-6 py-12">
        ...
        <div className="space-y-8 text-sm leading-relaxed text-neutral-700">
          ...
          <section>
            ...
            <p>
              就業規則AIのデータベースは、行レベルセキュリティ（RLS：Row Level Security）という仕組みで、データの1行1行に「どの会社のものか」を持たせ、データベース自体が「その会社のメンバー以外は読めない・書けない」を強制しています。
            </p>
            <p className="mt-2">
          ...
          <section>
            ...
            <p>
              アップロードされた規程や登録データの中に「これまでの指示を無視して」のようなAIへの指示文が紛れ込んでいても、就業規則AIはそれを指示として実行せず、点検・参照対象のデータとしてのみ扱うよう、AIへの指示を明示的に分離・防御しています。外部から取り込んだ文書がAIの動作を乗っ取ることを防ぐための多層的な対策で、継続的に強化しています。
            </p>
          </section>
