      ...
      <div className="mx-auto max-w-2xl px-6 py-12">
        ...
        <dl>
          ...
          <Row label="解約の条件・方法">
            ...
            現在、管理画面上でお客様ご自身が解約手続きを完了する機能は提供しておらず、
            メールでのお申し出を受けて当方が解約処理を行います（原則3営業日以内に処理し、完了をメールでご連絡します）。
            処理に日数を要するため、<strong>次回の請求日の7日前までにご連絡ください。</strong>
            それ以降のお申し出は、次回請求が発生した後の期間末解約となる場合があります。
            解約のお申し出をいただいた場合、現在お支払い済みの請求期間の末日をもって契約終了となり、
            期間末日まではサービスをご利用いただけます。
          </Row>
