  ...
  return (
    <div className="company-light min-h-screen bg-white">
      <div className="mx-auto max-w-2xl px-6 py-12">
        ...
        {/* 2026-07-25 CTO修正: 課金開始(BILLING_ENABLED=true)に伴い実態に合わせて更新。
            無料プランは引き続き存在するが、有料プランは実際に課金が発生する状態のため
            「現時点で課金は行っていません」という記載は法令上の表示として不正確だった。 */}
        <div className="mb-8 rounded-lg border border-neutral-200 bg-neutral-50 p-4 text-sm leading-relaxed text-neutral-700">
          <p>
            番頭（Banto）は無料プランでもご利用いただけますが、下記「販売価格」欄の有料プランは
            現在お申し込みいただけます。お客さまが有料プランを選び、お申し込み手続き
            （クレジットカード情報の入力を含むStripe決済画面での操作）を完了した時点で課金が発生します。
            お申し込みの操作をしない限り、課金が発生することはありません。
          </p>
        </div>
