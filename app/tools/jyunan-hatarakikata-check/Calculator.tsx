...
function SignupCta({
  ...
  return (
    <ToolSignupCta
      ...
      body={
        actionNeeded
          ? '措置の追加や個別周知・意向確認は、対象になる従業員ごとに時期が異なります。Kabauに無料登録して会社を作ると、いま画面に出ている点検結果がそのまま「会社の記憶」に保存されます。自社が講じている措置や対象になりそうな従業員も覚えさせれば、時期が来るたびに条件を入れ直さずに、同じ点検を続けられます。'
          : 'Kabauに無料登録して会社を作ると、いま画面に出ている点検結果がそのまま「会社の記憶」に保存されます。Kabauは自社の措置や対象の従業員を覚えるので、子の年齢が上がって対応の時期が来ても、前提を説明し直さずに同じ点検を続けられます。'
      }
