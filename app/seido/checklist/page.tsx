...
//   就業規則AI無料登録の特典（引き継ぎ書 設計骨子2）。このページは中身の見出しと
...
export const metadata: Metadata = {
  title: 'インボイス2026年10月対応チェックリスト（無料）｜就業規則AI',
  description:
    '2026年10月のインボイス経過措置縮小（80%から70%へ）と2割特例終了に向けて、買手・売手の立場別に確認することをまとめた無料チェックリストです。就業規則AIの無料登録で全項目を読めます。',
      ...
      <section className="mx-auto max-w-3xl px-6 pb-8">
        <Card className="bg-brand-600 text-center">
          ...
          <p className="mx-auto mt-3 max-w-xl text-sm leading-relaxed text-brand-100">
            就業規則AIは、就業規則のファイルを置くとずれが1枚になるサービスです。チェックリストの全文は無料登録の特典です。登録の前に、ファイルを置くこともできます。
          </p>
