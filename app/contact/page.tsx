...
//   ＝重複コンテンツ扱いのリスク、og:title/descriptionも「番頭 — 会社を覚える労務AI」の
//   トップページ用文言のまま）。他の主要ページ(/faq等)と同じ構造に揃える。
const BASE = 'https://banto-roumu.com'
const URL = `${BASE}/contact`
const TITLE = 'お問い合わせ｜番頭(Banto)'
const DESC = '番頭（Banto）へのお問い合わせ窓口です。サービスに関するご質問・不具合のご報告は、下記メールアドレス宛にご連絡ください。'
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    locale: 'ja_JP',
    type: 'website',
    images: [{ url: `${BASE}/og-image.png`, width: 1200, height: 630, alt: '番頭(Banto) お問い合わせ' }],
  },
  twitter: {
