  ...
  for (const companyId of companyIds) {
    try {
      ...
      for (const member of members) {
        ...
        //   このフラグは登録時の「就業規則AIの新機能・労務の最新情報をメールで受け取る（任意）」
        ...
        const resendRes = await fetch('https://api.resend.com/emails', {
          ...
          body: JSON.stringify({
            ...
            html: `<div style="font-family:sans-serif;max-width:520px;margin:0 auto;padding:24px">
              ...
              <a href="${homeUrl}" style="background:#324a8a;color:#ffffff;padding:12px 24px;border-radius:12px;text-decoration:none;display:inline-block;font-size:14px">就業規則AIで確認する</a>
              ...
              <p style="color:#9ca3af;font-size:11px;line-height:1.8">
                ...
                このメールは就業規則AIに登録された期限の備忘として送信されています。<br>
