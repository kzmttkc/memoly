...
export const SCENARIOS_EN: Scenario[] = [
  {
    ...
    topic: 'Teaching Banto the company\'s paid-leave rule and checking it answers with that exact setting',
  ...
  },
  {
    ...
    topic: 'Whether Banto can run alongside SmartHR and existing tools without double data entry',
