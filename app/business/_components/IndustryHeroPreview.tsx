      ...
      {selected === null ? (
        <>
          ...
          <div
            ...
            className="fv-chat"
            role="img"
            aria-label="就業規則AIとの会話例。昨日の相談の続きから今日の会話が始まる様子"
          >
            <div className="fv-chat__header">就業規則AI</div>
          ...
          <div
            ...
            role="img"
            aria-label="記憶残高の表示イメージ。規程・前提・相談の経緯が就業規則AIに積み上がっていく様子"
          >
  ...
  return (
    <div className="overflow-hidden rounded-2xl border border-neutral-200 bg-white shadow-sm">
      ...
      <div className="flex items-center gap-2 border-b border-neutral-200 bg-neutral-50 px-4 py-2.5">
        ...
        <span className="text-xs font-semibold text-neutral-700">就業規則AI</span>
