...
const CONFLICT_TOPICS: ConflictTopic[] = [
  ...
  {
    // 月60時間超の時間外50%は、中小企業への猶予（旧労基法138条）が2023-04-01に廃止。
    // それ以前に決めた残業代・固定残業代の設計は反映漏れの可能性がある＝確認対象。
    // ※ factKeys は施行日 2023-04-01 の 1件だけに絞る（wari_mashi_kihon 等は
    //   1994年施行で古く、newestFactForTopic の判定を鈍らせるため入れない）。
    label: '割増賃金率（月60時間超の時間外50%・中小企業は2023年4月から）',
    factKeys: ['wari_mashi_60over'],
    keywords: [
      '割増', '残業代', '残業手当', '時間外手当', '固定残業', 'みなし残業',
      '深夜手当', '休日出勤', '休日手当',
    ],
  },
  {
    // 年5日の時季指定義務は 2019-04-01 施行（企業規模を問わない）。
    label: '年5日の年次有給休暇の取得義務',
    factKeys: ['nenkyu_5nichi_gimu'],
    keywords: [
      '年次有給休暇', '有給休暇', '有給', '有休', '年休', '計画年休',
      '計画的付与', '時季指定',
    ],
  },
  // ※ 社会保険の適用拡大（shakai_hoken_tekiyo）はここに入れない。
  //   企業規模要件の拡大は 2027-10-01 など将来日付のため、過去のあらゆる判断が
  //   機械的に「施行日より前」となり、確認対象カードが無意味に乱発される。
  //   （harassment_2026 を入れていないのと同じ理由。）
]
