...
//   /blog は、就業規則AIの製品コンセプト「会社の規程を覚えるAI」の核にある
...
//   残らない・現場と乖離する）」という就業規則AIならではの角度に絞る。
//
...
export type BlogPost = {
  ...
  /** 記事末尾でまとめて触れる、就業規則AIがこの課題にどう接続するか */
  productTieIn: string[]
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          '就業規則AIは後者の考え方に立つツールです。就業規則や各種規程を登録しておくと、条文番号やページ数を覚えていなくても「うちの育休の扱いはどうなっているか」とそのまま聞いて確認できます。規程を書き換えるのではなく、規程への到達コストを下げることで、参照される状態に近づける位置づけです。',
        ],
      },
    ],
    productTieIn: [
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          '就業規則AIには、就業規則のような規程だけでなく、過去の運用や判断の経緯も登録して覚えさせられます。改定した条文だけでなく「なぜそう変えたか」という理由も一緒に記録しておけば、次に似た論点が出たときに、過去の検討を踏まえた状態から相談を始められます。',
        ],
      },
    ],
    productTieIn: [
      '規程の最新版がどれかを確認する作業と、なぜその内容になったのかを説明する作業の両方を、就業規則AIに聞く形に置き換えられます。改定のたびにファイルを配り直す運用から、一つの前提を更新し続ける運用への切り替えです。',
    ],
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          '就業規則AIには、就業規則の条文に加えて「実際にはこう運用している」という現場の実態も併せて登録できます。規程本文と運用実態にずれがある箇所を洗い出す使い方や、どちらを正として説明すべきかを整理する下書きの補助として使えます。最終的にどちらに揃えるかの判断は、会社側と、必要に応じて専門家が行う前提です。',
        ],
      },
    ],
    productTieIn: [
      '規程と運用のどちらを聞いても同じ前提から答えが返ってくる状態を作ることが、乖離そのものを縮める一歩になります。就業規則AIはその前提を、条文と運用実態の両方から覚えます。',
    ],
